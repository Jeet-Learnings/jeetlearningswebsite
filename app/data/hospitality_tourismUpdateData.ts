...
export const hospitality_tourismUpdateData: Record<string, CareerPageData> = {
  air_hostess: {
    slug: "air_hostess",
    badge: "Career Exploration for Class 10+",
    heading: "Air Hostess",
    subheading: "Explore opportunities in Air Hostess.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Air Hostess.", borderColor: "#10B981" },
    ...
    guideSections: [
      {
        ...
        icon: "Target",
        description: "Understanding Air Hostess.",
        color: RED,
        content: [
          "Air Hostess is a dynamic and rewarding career path.",
  ...
  culinary_arts: {
    ...
    subheading: "Explore opportunities in Culinary Arts.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Culinary Arts.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Culinary Arts.",
        color: RED,
        content: [
          "Culinary Arts is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
  ...
  event_planning: {
    ...
    subheading: "Explore opportunities in Event Planning.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Event Planning.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Event Planning.",
        color: RED,
        content: [
          "Event Planning is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
  ...
  hotel_management: {
    ...
    subheading: "Explore opportunities in Hotel Management.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Hotel Management.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Hotel Management.",
        color: RED,
        content: [
          "Hotel Management is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
  ...
  travel_and_tourism: {
    ...
    subheading: "Explore opportunities in Travel and Tourism.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Travel and Tourism.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Travel and Tourism.",
        color: RED,
        content: [
          "Travel and Tourism is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
  ...
  wedding_planning: {
    ...
    subheading: "Explore opportunities in Wedding Planning.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Wedding Planning.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Wedding Planning.",
        color: RED,
        content: [
          "Wedding Planning is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
