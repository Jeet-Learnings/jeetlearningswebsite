...
export const media_and_communicationUpdateData: Record<string, CareerPageData> = {
  international_relations: {
    ...
    guideSections: [
      ...
      },
      {
        ...
        color: COLOR1,
        content: [
          "Government: Jawaharlal Nehru University (JNU), New Delhi; University of Delhi (Department of Political Science); Jadavpur University, Kolkata; Indian Institute of Foreign Trade (IIFT), New Delhi",
          "Private: Symbiosis School of International Studies, Pune; Jindal School of International Affairs, Sonipat; Amity Institute of International Studies, Noida; Manipal Academy of Higher Education, Manipal",
          "Online: Coursera (Yale & Stanford International Relations); NPTEL (IIT/JNU International Politics Courses); edX (LSE & Oxford Global Affairs Programmes); SWAYAM (UGC International Relations Courses)"
        ]
      },
      {
        id: "opportunities",
        ...
        color: COLOR2,
        content: [
          "Conventional: Indian Foreign Service (IFS) Officer through UPSC Civil Services Examination; Diplomat/Attaché at Indian Embassies and High Commissions abroad; Policy Analyst at Ministry of External Affairs (MEA) and Ministry of Defence; Research Officer at think tanks",
  ...
  journalism: {
    ...
    badge: "Career Exploration for Class 10+",
    heading: "Journalism",
    subheading: "Explore opportunities in Journalism.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Journalism.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Journalism.",
        color: COLOR1,
        content: [
          "Journalism is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
      ...
      },
      {
        ...
        color: COLOR1,
        content: [
          "Government: Indian Institute of Mass Communication (IIMC), New Delhi; Jawaharlal Nehru University (JNU), New Delhi; University of Delhi (Delhi School of Journalism); Banaras Hindu University (BHU), Varanasi",
          "Private: Symbiosis Institute of Media & Communication, Pune; Xavier Institute of Communications (XIC), Mumbai; Manipal School of Communication, Manipal; Asian College of Journalism (ACJ), Chennai",
          "Online: Coursera (Michigan & Columbia Journalism Courses); edX (UC Berkeley Media & Journalism); SWAYAM (UGC Journalism & Mass Communication); Google News Initiative (Digital Journalism Training)"
        ]
      },
      {
        id: "opportunities",
  ...
  mass_communication: {
    ...
    subheading: "Explore opportunities in Mass Communication.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Mass Communication.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Mass Communication.",
        color: COLOR1,
        content: [
          "Mass Communication is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
      ...
      },
      {
        ...
        color: COLOR1,
        content: [
          "Government: Indian Institute of Mass Communication (IIMC), New Delhi; Jamia Millia Islamia (AJK MCRC), New Delhi; University of Madras, Chennai; Aligarh Muslim University (AMU), Aligarh",
          "Private: Symbiosis Institute of Media & Communication, Pune; Amity School of Communication, Noida; Christ University, Bangalore; Whistling Woods International, Mumbai",
          "Online: SWAYAM (UGC Mass Communication Courses); Coursera (Media & Communication Specializations); edX (Digital Media & Communication); NPTEL (IIT Media Studies Programmes)"
        ]
      },
      {
        id: "opportunities",
  ...
  public_relations: {
    ...
    subheading: "Explore opportunities in Public Relations.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Public Relations.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Public Relations.",
        color: COLOR1,
        content: [
          "Public Relations is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
      ...
      },
      {
        ...
        color: COLOR1,
        content: [
          "Government: Indian Institute of Mass Communication (IIMC), New Delhi; Jamia Millia Islamia (AJK MCRC), New Delhi; University of Delhi (Delhi School of Journalism); University of Mumbai (Department of Communication Studies)",
          "Private: Xavier Institute of Communications (XIC), Mumbai; Symbiosis Institute of Media & Communication, Pune; Amity School of Communication, Noida; Manipal School of Communication, Manipal",
          "Online: Coursera (Google & Meta Public Relations Courses); edX (Rochester & Georgetown PR Programmes); SWAYAM (UGC Public Relations Courses); LinkedIn Learning (PR Strategy & Media Relations)"
        ]
      },
      {
        id: "opportunities",
