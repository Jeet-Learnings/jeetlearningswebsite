...
export const logistics_transportationUpdateData: Record<string, CareerPageData> = {
  aeronautical_engineering: {
    slug: "aeronautical_engineering",
    badge: "Career Exploration for Class 10+",
    heading: "Aeronautical Engineering",
    subheading: "Explore opportunities in Aeronautical Engineering.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Aeronautical Engineering.", borderColor: "#10B981" },
    ...
    guideSections: [
      {
        ...
        icon: "Target",
        description: "Understanding Aeronautical Engineering.",
        color: RED,
        content: [
          "Aeronautical Engineering is a dynamic and rewarding career path.",
