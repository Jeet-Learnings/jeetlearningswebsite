...
export const science_mathematics_engineeringUpdateData: Record<string, CareerPageData> = {
  astronomy: {
    ...
    heading: "Astronomy",
    subheading: "Explore opportunities in Astronomy.",
    whyCards: [
  ...
  biomedical_engineering: {
    ...
    subheading: "Explore opportunities in Biomedical Engineering.",
    whyCards: [
  ...
  chemical_engineering: {
    ...
    subheading: "Explore opportunities in Chemical Engineering.",
    whyCards: [
  ...
  engineering_technology: {
    ...
    subheading: "Explore opportunities in Engineering & Technology.",
    whyCards: [
  ...
  mathematician: {
    ...
    subheading: "Explore opportunities in Mathematician.",
    whyCards: [
  ...
  mechatronics: {
    ...
    subheading: "Explore opportunities in Mechatronics.",
    whyCards: [
  ...
  nanotechnology: {
    ...
    subheading: "Explore opportunities in Nanotechnology.",
    whyCards: [
  ...
  robotics: {
    ...
    badge: "Career Exploration for Class 10+",
    heading: "Robotics",
    subheading: "Explore opportunities in Robotics.",
    whyCards: [
  ...
  statistician: {
    ...
    subheading: "Explore opportunities in Statistician.",
    whyCards: [
