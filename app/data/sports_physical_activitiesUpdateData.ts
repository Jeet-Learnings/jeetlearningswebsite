...
export const sports_physical_activitiesUpdateData: Record<string, CareerPageData> = {
  ...
  sports_physiotherapist: {
    ...
    subheading: "Explore opportunities in Sports Physiotherapist.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Sports Physiotherapist.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Sports Physiotherapist.",
        color: "#DC2626",
        content: [
          "Sports Physiotherapist is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
  ...
  sportsperson: {
    ...
    subheading: "Explore opportunities in Sportsperson.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Sportsperson.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Sportsperson.",
        color: "#DC2626",
        content: [
          "Sportsperson is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
