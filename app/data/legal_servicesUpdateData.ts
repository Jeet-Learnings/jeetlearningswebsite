...
export const legal_servicesUpdateData: Record<string, CareerPageData> = {
  forensic_scientist: {
    slug: "forensic_scientist",
    badge: "Career Exploration for Class 10+",
    heading: "Forensic Scientist",
    subheading: "Explore opportunities in Forensic Scientist.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Forensic Scientist.", borderColor: "#10B981" },
    ...
    guideSections: [
      {
        ...
        icon: "Target",
        description: "Understanding Forensic Scientist.",
        color: RED,
        content: [
          "Forensic Scientist is a dynamic and rewarding career path.",
  ...
  lawyer: {
    ...
    badge: "Career Exploration for Class 10+",
    heading: "Lawyer",
    subheading: "Explore opportunities in Lawyer.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Lawyer.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Lawyer.",
        color: RED,
        content: [
          "Lawyer is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
  ...
  judiciary: {
    ...
    badge: "Career Exploration for Class 10+",
    heading: "Judiciary",
    subheading: "Explore opportunities in Judiciary.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Judiciary.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Judiciary.",
        color: RED,
        content: [
          "Judiciary is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
