...
export const manufacturingUpdateData: Record<string, CareerPageData> = {
  industrial_design: {
    ...
    subheading: "Explore opportunities in Industrial Design.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Industrial Design.", borderColor: "#10B981" },
    ...
    guideSections: [
      {
        ...
        icon: "Target",
        description: "Understanding Industrial Design.",
        color: "#6B7280",
        content: [
          "Industrial Design is a dynamic and rewarding career path.",
  ...
  industrial_engineering: {
    ...
    subheading: "Explore opportunities in Industrial Engineering.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Industrial Engineering.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Industrial Engineering.",
        color: "#6B7280",
        content: [
          "Industrial Engineering is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
  ...
  mechanical_engineering: {
    ...
    subheading: "Explore opportunities in Mechanical Engineering.",
    whyCards: [
      { icon: "Briefcase", title: "Career Growth", description: "Build a successful career in Mechanical Engineering.", borderColor: "#10B981" },
      { icon: "TrendingUp", title: "Market Demand", description: "High demand in the industry.", borderColor: "#059669" },
      { icon: "Globe", title: "Global Opportunities", description: "Work globally in this field.", borderColor: "#3B82F6" },
      { icon: "Zap", title: "Innovation", description: "Be part of industry innovation.", borderColor: "#F59E0B" }
    ],
    ...
    guideSections: [
      {
        ...
        title: "What is This Career All About?",
        icon: "Target",
        description: "Understanding Mechanical Engineering.",
        color: "#6B7280",
        content: [
          "Mechanical Engineering is a dynamic and rewarding career path.",
          "It offers opportunities for growth and development.",
          "Professionals in this field make a significant impact.",
          "The industry is evolving with new technologies.",
          "Career prospects are excellent for qualified candidates."
