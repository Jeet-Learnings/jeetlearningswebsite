        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="space-y-6">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-slate-900">
              <TranslatedText as="span">{displayName}</TranslatedText>
              <br />
              <span className="text-blue-600">
                <TranslatedText as="span">Career Paths</TranslatedText>
              </span>
            </h1>
            ...
            <div className="flex flex-wrap gap-8 pt-2">
              <div>
                ...
                <div className="text-sm text-slate-600">
                  <TranslatedText>Career Options</TranslatedText>
                </div>
              </div>
              <div>
                <div className="text-3xl font-bold text-blue-600">10K+</div>
                <div className="text-sm text-slate-600">
                  <TranslatedText>Students Guided</TranslatedText>
                </div>
              </div>
              <div>
                    ...
                    <div className="p-5 flex-1 flex flex-col">
                      ...
                      <div className="flex items-center gap-2 mt-auto pt-3 border-t border-slate-100">
                        ...
                        <p className="text-slate-500 text-xs">
                          <TranslatedText>
                            Premium career track with expert mentorship
                          </TranslatedText>
                        </p>
                      </div>
                    </div>
